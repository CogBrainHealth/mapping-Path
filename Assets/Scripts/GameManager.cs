...
public class GameManager : MonoBehaviour
{
    ...
    public void GameOverText()
    {
        if (score > 25.27)
        {
            ...
            message.text += "길찾기 게임을 통해 기억력을\n검사했어요!\n\n" +
                             " <sprite name=\"rocket\">최고 수준의 기억력!\n" +
                             dataManager.nickName + "님은 20대 수준의 기억력을 가지고\n있어요!\n" +
                             "한 번 본 경로를 거의 완벽하게 기억하고 재현할 수 있는 능력을 가지고 있네요.\n\n" +
                             " <sprite name=\"check\">이 수준을 유지하려면?\n" +
                             "- 경로를 기억할 때 시각적 이미지\n(예: 나무, 건물, 표지판 등)를 떠올려 보세요.\n" +
        ...
        else if (score > 24.09)
        {
            ...
            message.text += "길찾기 게임을 통해 기억력을\n검사했어요!\n\n" +
                             " <sprite name=\"gift\">우수한 기억력!\n" +
                             dataManager.nickName + "님은 30대 수준의 기억력을 가지고\n있어요!\n" +
                             "경로를 빠르게 파악하고 기억하는 능력이 뛰어나며, 실수 없이 재현할 가능성이 높아요.\n\n" +
                             " <sprite name=\"check\">이 능력을 더 키우려면?\n" +
        ...
        else if (score > 19.41)
        {
            ...
            message.text += "길찾기 게임을 통해 기억력을\n검사했어요!\n\n" +
                             " <sprite name=\"good\">균형 잡힌 기억력!\n\n" +
                             dataManager.nickName + "님은 40대 수준의 기억력을 가지고\n있어요!\n" +
                             "전체 경로를 한 번에 기억하기보다는, 주요 지점(랜드마크 중심)으로 기억하는 경향이 있어요.\n\n" +
                             " <sprite name=\"check\">좀 더 향상시키려면?\n" +
        ...
        else if (score > 13.16)
        {
            ...
            message.text += "길찾기 게임을 통해 기억력을\n검사했어요!\n\n" +
                             ...
                             dataManager.nickName + "님은 50대 수준의 기억력을 가지고\n있어요!\n" +
                             "길을 찾을 때 여러 번 생각해야 하거나, 중간에 일부 경로를 잊을 가능성이 있어요.\n\n" +
                             " <sprite name=\"check\">더 나은 기억력을 원한다면?\n" +
        ...
        else if (score > 8.84)
        {
            ...
            message.text += "길찾기 게임을 통해 기억력을\n검사했어요!\n\n" +
                             ...
                             dataManager.nickName + "님은 60대 수준의 기억력을 가지고\n있어요!\n" +
                             "경로를 기억하는 데 시간이 걸릴 수 있으며, 일부 정보가 빠르게 사라질 수 있어요.\n\n" +
                             " <sprite name=\"check\">훈련을 위해?\n" +
        ...
        else
        {
            ...
            message.text += "길찾기 게임을 통해 기억력을\n검사했어요!\n\n" +
                             " <sprite name=\"weight\">조금 더 연습하면 기억력이 향상될 거예요!\n" +
                             dataManager.nickName + "님은 70대 수준의 기억력을 가지고\n있어요!\n" +
